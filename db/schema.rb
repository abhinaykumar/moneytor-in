...
ActiveRecord::Schema.define(version: 2020_09_19_092116) do
  ...
  create_table "listed_mutual_funds", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["name"], name: "index_listed_mutual_funds_on_name"
  end
  ...
  create_table "listed_stocks", force: :cascade do |t|
    ...
    t.index ["name"], name: "index_listed_stocks_on_name"
  end
